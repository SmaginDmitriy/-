...
public class JFreeChartMainFrame extends JFrame {
    ...
    private JFreeChart createChart() {
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("y = sin(a x) / x", /* chart title */ "X", /* x axis label */ "Y", /* y axis label */ dataset, /* data */PlotOrientation.VERTICAL, true, /* include legend */ true, /* tooltips */ false /* urls */);
